...
function populateListProductChoices(slct1, slct2) {
  ...
  for (i = 0; i < optionArray.length; i++) {
    ...
    //create a picture for each food
    var picture = document.createElement("IMG");
    picture.setAttribute("src", optionArray[i].image);
...
function selectedItems() {
  ...
  para.innerHTML = "Your selected items : ";
...
window.onload = populateListProductChoices("categories", "displayProduct");
